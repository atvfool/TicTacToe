...
#End Region
    ...
    Public Sub InitializePaths()
        ...
        Try
            ...
            m_clsAboveBoardToSquare1.AddSuperMoveToPath(0, 0, 0, -475, 300, 0)

            m_clsAboveBoardToSquare2 = New CPath()
            m_clsAboveBoardToSquare2.AddSuperMoveToPath(0, 0, 0, -495, 270, 0)
            ...
            m_clsAboveBoardToSquare4.AddSuperMoveToPath(0, 0, 0, -350, 395, 0)

            m_clsAboveBoardToSquare5 = New CPath()
            m_clsAboveBoardToSquare5.AddSuperMoveToPath(0, 0, 0, -375, 370, 0)

            m_clsAboveBoardToSquare6 = New CPath()
            m_clsAboveBoardToSquare6.AddSuperMoveToPath(0, 80, 0, 0, 0, 90)
            m_clsAboveBoardToSquare6.AddSuperMoveToPath(0, 0, 0, -350, 395, 0)
