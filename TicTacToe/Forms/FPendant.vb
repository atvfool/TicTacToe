...
#Region "Form Events"
    ...
    Private Sub btnAboveBoard_Click(sender As Object, e As EventArgs) Handles btnAboveBoard.Click
        ...
        Try
            ...
            MoveTo(enuLocationType.AboveBoard)
    ...
    ' -------------------------------------------------------------------------
    ' Name: btnHandOpen_Click
    ' Abstract: Opens the gripper
    ' -------------------------------------------------------------------------
    Private Sub btnHandOpen_Click(sender As Object, e As EventArgs) Handles btnHandOpen.Click
    ...
    ' -------------------------------------------------------------------------
    ' Name: btnHandClose_Click
    ' Abstract: Closes the gripper
    ' -------------------------------------------------------------------------
    Private Sub btnHandClose_Click(sender As Object, e As EventArgs) Handles btnHandClose.Click
    ...
    ' -------------------------------------------------------------------------
    Private Sub btnX1_Click(sender As Object, e As EventArgs) Handles btnX1.Click
    ...
    ' Abstract: Goes to tic tac toe tray spot 7
    ' -------------------------------------------------------------------------
    Private Sub btnX4_Click(sender As Object, e As EventArgs) Handles btnX4.Click
    ...
    ' -------------------------------------------------------------------------
    Private Sub btnX5_Click(sender As Object, e As EventArgs) Handles btnX5.Click
    ...
    ' -------------------------------------------------------------------------
    Private Sub btnO5_Click(sender As Object, e As EventArgs) Handles btnO5.Click

        Try

            SetBusyCursor(Me, True)

            MoveTo(enuLocationType.O5)
